...
class UserProvider extends ChangeNotifier {
    ...
    if (user != null) {
      try {
        ...
        if (userDoc.exists) {
          ...
          debugPrint('✅ FetchUserData - Firestore image: $firestoreImage');
          debugPrint('✅ FetchUserData - Auth image: $authImage');
          debugPrint('✅ FetchUserData - Final image: $_profileImage');
      ...
      try {
        ...
        if (userDoc.exists) {
          ...
          if (firestoreImage.isNotEmpty && authImage != firestoreImage) {
            ...
            debugPrint('✅ Synced image from Firestore to Auth: $firestoreImage');
          }
          
          debugPrint('✅ RefreshProfileImage - Final image: $_profileImage');
          notifyListeners();
        }
      } catch (e) {
  ...
  Future<void> updateProfileImage(String imageUrl) async {
    try {
      final user = FirebaseAuth.instance.currentUser;
      if (user != null) {
        debugPrint('📤 Updating profile image to: $imageUrl');
        ...
        debugPrint('✅ Saved image in Firestore: $savedImage');
        debugPrint('✅ Saved image in Auth: $authImage');
  ...
  void reset() {
    ...
    _profileImage = '';
    notifyListeners();
    debugPrint('🔄 UserProvider reset - all data cleared');
  }
}